...
int main(int, char**)
{
    ...
    m->eta = 1.5;
    m->n = 16;
    // Object *sphere = new Sphere(Vector3D(2, 2, -12), 2, m);
    Object *sphere = new Sphere(Vector3D(0, 0, -10), 3, m);
    world->addObject(sphere);
    Material *m2 = new Material(world);
    m2->color = Color(0.1, 0.5, 0.0);
    m2->ka = 0.1;
    m2->kd = 0.9;
    m2->ks = 0.7;
    m2->n = 16;

    Object *triangle = new Triangle(Vector3D(-10, -10, -11), Vector3D(10, -5, -21), Vector3D(0, 10, -21), m2);
    world->addObject(triangle);

    LightSource *light = new PointLightSource(world, Vector3D(5, 10, 12), Color(1, 1, 1));
