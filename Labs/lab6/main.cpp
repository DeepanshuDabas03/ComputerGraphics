...
int main(int, char **)
{
    ...
    float vertices[] = {
        ...
        // left
        -0.75f, -0.75f, 0.0f, 0.0f, 0.0f, // bottom-left 
        -0.75f, -0.75f, 1.5f, 1.0f, 0.0f, // bottom-right 
        -0.75f, 0.75f, 0.0f, 0.0f, 1.0f,  // top-left 

        -0.75f, -0.75f, 1.5f, 1.0f, 0.0f, // bottom-right 
        -0.75f, 0.75f, 1.5f, 1.0f, 1.0f,  // top-right 
        -0.75f, 0.75f, 0.0f, 0.0f, 1.0f,  // top-left 
        ...
        // back
        -0.75f, -0.75f, 1.5f, 0.0f, 0.0f, // bottom-left 
        0.75f, -0.75f, 1.5f, 1.0f, 0.0f,  // bottom-right 
        -0.75f, 0.75f, 1.5f, 0.0f, 1.0f,  // top-left 
        ...
        // top
        -0.75f, 0.75f, 0.0f, 0.0f, 0.0f, // front top-left
        0.75f, 0.75f, 0.0f, 1.0f, 0.0f,  // front top-right
        -0.75f, 0.75f, 1.5f, 0.0f, 1.0f, // back top-left

        0.75f, 0.75f, 0.0f, 1.0f, 0.0f,  // front top-right
        0.75f, 0.75f, 1.5f, 1.0f, 1.0f,  // back top-right
        -0.75f, 0.75f, 1.5f, 0.0f, 1.0f, // back top-left

        // bottom
        -0.75f, -0.75f, 0.0f, 0.0f, 0.0f, // front bottom-left
        0.75f, -0.75f, 0.0f, 1.0f, 0.0f,  // front bottom-right
        -0.75f, -0.75f, 1.5f, 0.0f, 1.0f, // back bottom-left

        0.75f, -0.75f, 0.0f, 1.0f, 0.0f, // front bottom-right
        0.75f, -0.75f, 1.5f, 1.0f, 1.0f, // back bottom-right
        -0.75f, -0.75f, 1.5f, 0.0f, 1.0f // back bottom-left
